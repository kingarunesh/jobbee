...
import { jobTypeOptions, educationOptions, experienceOptions, industriesOptions } from "./data";
...
const UpdateJob = ({ job, access_token }) => {
    ...
    const { error, clearErrors, loading, updated, setUpdated, updateJob } = useContext(JobContext);
