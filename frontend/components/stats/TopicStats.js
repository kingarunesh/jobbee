...
const TopicStats = () => {
    ...
    const { loading, error, clearErrors, getTopicStats, stats } = useContext(JobContext);
                                ...
                                stats && (
                                    <>
                                        ...
                                        <div className="alert alert-danger mt-4">
                                            <b>Note:</b> These stats are collected from the jobs that are posted only on Jobbee.
                                            Do not compare these stats with other sites.
                                        </div>
                                    </>
                                )
                            )}
